...
library(readr)
dataset <- read_csv("C:/Users/pablo/Desktop/analisisExploratorio/dataset.csv", 
...
El análisis muestra que no hay una única variable que pueda predecir de manera confiable el resultado de la solicitud de crédito. Esto indica la complejidad del proceso de toma de decisiones que probablemente involucra múltiples factores y posiblemente interacciones complejas entre estas variables.
